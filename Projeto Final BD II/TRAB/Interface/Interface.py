...
class Ui_DashBoard(object):
    def setupUi(self, DashBoard):
        ...
        DashBoard.setMinimumSize(QtCore.QSize(1000, 720))
        ...
        DashBoard.setStyleSheet("QMainWindow {background: transparent; }\n"
"QToolTip {\n"
"    color: #ffffff;\n"
...
"}")
        ...
        self.pushButton_2 = QtWidgets.QPushButton(self.frame_menus)
        self.pushButton_2.setStyleSheet("")
        self.pushButton_2.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/20x20/icons/20x20/cil-home.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_2.setIcon(icon3)
        self.pushButton_2.setObjectName("pushButton_2")
        self.layout_menus.addWidget(self.pushButton_2)
        self.pushButton = QtWidgets.QPushButton(self.frame_menus)
        self.pushButton.setStyleSheet("")
        self.pushButton.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/20x20/icons/20x20/cil-screen-desktop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        self.comboBox = QtWidgets.QComboBox(self.frame_content_wid_1)
        ...
        self.label_3 = QtWidgets.QLabel(self.frame_content_wid_1)
...
"border-radius: 5px;")
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(12, 21, 851, 32))
        ...
        self.horizontalSlider.setGeometry(QtCore.QRect(12, 80, 271, 16))
        self.horizontalSlider.setStyleSheet("color:#717072;\n"
"\n"
"")
        self.horizontalSlider.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider.setObjectName("horizontalSlider")
        self.btnConsultar = QtWidgets.QPushButton(self.frame_2)
        self.btnConsultar.setGeometry(QtCore.QRect(320, 70, 101, 31))
        self.btnConsultar.setStyleSheet("background-color: rgb(87, 154, 255);")
        self.btnConsultar.setObjectName("btnConsultar")
        self.label_2 = QtWidgets.QLabel(self.frame_2)
        self.label_2.setGeometry(QtCore.QRect(10, 100, 59, 16))
        self.label_2.setObjectName("label_2")
        self.currenteAno = QtWidgets.QLabel(self.frame_2)
        self.currenteAno.setGeometry(QtCore.QRect(50, 100, 59, 16))
        self.currenteAno.setObjectName("currenteAno")
...
"}")
        ...
        DashBoard.setTabOrder(self.btn_minimize, self.btn_maximize_restore)
        DashBoard.setTabOrder(self.btn_maximize_restore, self.btn_close)
        DashBoard.setTabOrder(self.btn_close, self.btn_toggle_menu)
        DashBoard.setTabOrder(self.btn_toggle_menu, self.tableWidget)

    def retranslateUi(self, DashBoard):
        _translate = QtCore.QCoreApplication.translate
        DashBoard.setWindowTitle(_translate("DashBoard", "MainWindow"))
        self.btn_minimize.setToolTip(_translate("DashBoard", "Minimize"))
        self.btn_maximize_restore.setToolTip(_translate("DashBoard", "Maximize"))
        self.btn_close.setToolTip(_translate("DashBoard", "Close"))
        self.label_6.setText(_translate("DashBoard", "HOME"))
        self.label.setText(_translate("DashBoard", "Empyt Page - By: Wanderson M. Pimenta"))
        self.label_7.setText(_translate("DashBoard", "Page Index 0"))
        self.comboBox.setItemText(0, _translate("DashBoard", "Ativos"))
        self.comboBox.setItemText(1, _translate("DashBoard", "Compra"))
        self.comboBox.setItemText(2, _translate("DashBoard", "Despesa"))
        self.comboBox.setItemText(3, _translate("DashBoard", "Estoque"))
        self.comboBox.setItemText(4, _translate("DashBoard", "Gastos"))
        self.comboBox.setItemText(5, _translate("DashBoard", "Pessoal"))
        self.comboBox.setItemText(6, _translate("DashBoard", "Receita"))
        self.comboBox.setItemText(7, _translate("DashBoard", "Setor"))
        self.label_3.setText(_translate("DashBoard", "Selecione uma area"))
        self.comboBox_2.setItemText(0, _translate("DashBoard", "Total"))
        self.comboBox_2.setItemText(1, _translate("DashBoard", "Comercio de veiculos, pecas e motocicletas"))
        self.comboBox_2.setItemText(2, _translate("DashBoard", "Veiculos automotores"))
        self.comboBox_2.setItemText(3, _translate("DashBoard", "Pecas para veiculos"))
        self.comboBox_2.setItemText(4, _translate("DashBoard", "Motocicletas, pecas e acessorios"))
        self.comboBox_2.setItemText(5, _translate("DashBoard", "Comercio por atacado"))
        self.comboBox_2.setItemText(6, _translate("DashBoard", "Representantes e agentes do comercio (exceto de veiculos e motocicletas)"))
        self.comboBox_2.setItemText(7, _translate("DashBoard", "Comercio de materias-primas agricolas e animais vivos"))
        self.comboBox_2.setItemText(8, _translate("DashBoard", "Comercio especializado em produtos alimenticios, bebidas e fumo"))
        self.comboBox_2.setItemText(9, _translate("DashBoard", "Comercio de equipamentos e artigos de uso pessoal e domestico"))
        self.comboBox_2.setItemText(10, _translate("DashBoard", "Tecidos, artefatos de tecidos e de armarinho, vestuario, calcados e artigos de viagem"))
        self.comboBox_2.setItemText(11, _translate("DashBoard", "Tecidos, artefatos de tecidos e de armarinho"))
        self.comboBox_2.setItemText(12, _translate("DashBoard", "Artigos de vestuario e acessorios"))
        self.comboBox_2.setItemText(13, _translate("DashBoard", "Calcados e artigos de viagem"))
        self.comboBox_2.setItemText(14, _translate("DashBoard", "Produtos farmaceuticos, medicos, ortopedicos, odontologicos e veterinarios"))
        self.comboBox_2.setItemText(15, _translate("DashBoard", "Artigos de escritorio e de papelaria; papel. papelao e seus artefatos; livros, jornais e outras publicacoes"))
        self.comboBox_2.setItemText(16, _translate("DashBoard", "Outros equipamentos e artigos de uso pessoal e domestico"))
        self.comboBox_2.setItemText(17, _translate("DashBoard", "Comercio de produtos intermediarios, residuos e sucatas"))
        self.comboBox_2.setItemText(18, _translate("DashBoard", "Combustiveis e lubrificantes"))
        self.comboBox_2.setItemText(19, _translate("DashBoard", "Madeira, ferragens, ferramentas, material eletrico e material de construcao"))
        self.comboBox_2.setItemText(20, _translate("DashBoard", "Produtos quimicos, adubos e fertilizantes"))
        self.comboBox_2.setItemText(21, _translate("DashBoard", "Produtos siderurgicos e metalurgicos"))
        self.comboBox_2.setItemText(22, _translate("DashBoard", "Papel e papelao em bruto e de embalagens"))
        self.comboBox_2.setItemText(23, _translate("DashBoard", "Residuos, sucatas e outros produtos"))
        self.comboBox_2.setItemText(24, _translate("DashBoard", "Residuos e sucatas"))
        self.comboBox_2.setItemText(25, _translate("DashBoard", "Outros produtos"))
        self.comboBox_2.setItemText(26, _translate("DashBoard", "Comercio de equipamentos e produtos de tecnologia de informacao e comunicacao"))
        self.comboBox_2.setItemText(27, _translate("DashBoard", "Comercio de maquinas, aparelhos e equipamentos (exceto de tecnologia de informacao e comunicacao)"))
        self.comboBox_2.setItemText(28, _translate("DashBoard", "Comercio nao especializado"))
        self.comboBox_2.setItemText(29, _translate("DashBoard", "Comercio varejista"))
        self.comboBox_2.setItemText(30, _translate("DashBoard", "Comercio nao especializado"))
        self.comboBox_2.setItemText(31, _translate("DashBoard", "Hipermercados e supermercados"))
        self.comboBox_2.setItemText(32, _translate("DashBoard", "Outros tipos de comercio nao especializados com predominancia de produtos alimenticios"))
        self.comboBox_2.setItemText(33, _translate("DashBoard", "Comercio nao especializado sem predominancia de produtos alimenticios"))
        self.comboBox_2.setItemText(34, _translate("DashBoard", "Produtos alimenticios, bebidas e fumo"))
        self.comboBox_2.setItemText(35, _translate("DashBoard", "Tecidos, artigos de armarinho, vestuario e calcados"))
        self.comboBox_2.setItemText(36, _translate("DashBoard", "Tecidos e artigos de armarinho"))
        self.comboBox_2.setItemText(37, _translate("DashBoard", "Artigos do vestuario e complementos"))
        self.comboBox_2.setItemText(38, _translate("DashBoard", "Calcados, artigos de couro e viagem"))
        self.comboBox_2.setItemText(39, _translate("DashBoard", "Combustiveis e lubrificantes"))
        self.comboBox_2.setItemText(40, _translate("DashBoard", "Comercio de outros produtos em lojas especializadas"))
        self.comboBox_2.setItemText(41, _translate("DashBoard", "Produtos farmaceuticos, perfumaria e cosmeticos e artigos medicos, opticos e ortopedicos"))
        self.comboBox_2.setItemText(42, _translate("DashBoard", "Eletrodomesticos, equipamentos de audio e video, instrumentos musicais e acessorios"))
        self.comboBox_2.setItemText(43, _translate("DashBoard", "Moveis, artigos de iluminacao, pecas e acessorios e outros artigos de uso domestico"))
        self.comboBox_2.setItemText(44, _translate("DashBoard", "Material de construcao"))
        self.comboBox_2.setItemText(45, _translate("DashBoard", "Equipamentos de informatica e comunicacao"))
        self.comboBox_2.setItemText(46, _translate("DashBoard", "Artigos culturais, recreativos e esportivos"))
        self.comboBox_2.setItemText(47, _translate("DashBoard", "Gas liquefeito de petroleo (GLP)"))
        self.comboBox_2.setItemText(48, _translate("DashBoard", "Outros produtos novos"))
        self.comboBox_2.setItemText(49, _translate("DashBoard", "Comercio de artigos usados"))
        self.btnConsultar.setText(_translate("DashBoard", "Consultar"))
        self.label_2.setText(_translate("DashBoard", "2007"))
        self.currenteAno.setText(_translate("DashBoard", "2007"))
        self.label_4.setText(_translate("DashBoard", "Selecione um Setor"))
        self.tableWidget.setSortingEnabled(False)
        self.label_credits.setText(_translate("DashBoard", "Registered by: Wanderson M. Pimenta"))
        self.label_version.setText(_translate("DashBoard", "BETA TEST"))
import files_rc

...
def logar(tabelas):
        ...
        con = ConexaoComBD
        con.startConnection(usuario,senha)
        consulta="select retorna_tabelas('"+usuario+"')"
        lista=con.QueryTol(consulta)
        for idx in range(len(lista)):
                item=str(lista[idx]).replace("(","")
                item=item.replace(")","")
                item=item.replace(",","")
                item=item.replace("'","")
                consulta="select retorna_atributos('"+item +"')"
                lista2=con.QueryTol(consulta)
                for idx in range(len(lista2)):
                           item2=item+" - "+str(lista2[idx]).replace("(","")
                           item2=item2.replace(")","")
                           item2=item2.replace(",","")
                           item2=item2.replace("'","")
                           tabelas.append(item2)   
...
"")
        ...
        self.frame_content_wid_1.setMaximumSize(QtCore.QSize(900, 16777215))
        ...
        self.label_4 = QtWidgets.QLabel(self.frame_content_wid_1)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 0, 0, 1, 1)
        self.comboBox_3 = QtWidgets.QComboBox(self.frame_content_wid_1)
        self.comboBox_3.setObjectName("comboBox_3")
        self.comboBox_3.addItems(tabelas)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_top_info_1.setText(_translate("MainWindow", "IBGE Consulta"))
        ...
        self.label_4.setText(_translate("MainWindow", "Atributos"))
        ...
        item.setText(_translate("MainWindow", "Dados"))
    ...
    def OnClick(self):
        item = QTableWidgetItem(self.comboBox_3.currentText())
        self.tableWidget.setItem(self.linha,0,item)
        self.linha+=1
